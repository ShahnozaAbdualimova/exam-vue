...
<template>
  <header class="bg-white">
    <div class="container flex justify-between mx-auto p-5">
      <RouterLink to="/"><img src="/logo.svg" alt="" /></RouterLink>
      <div class="flex justify-between items-center gap-x-10">
        <div
          class="bg-grey-300 p-2.5 rounded-md flex justify-between items-center gap-2"
        >
          <p class="font-bold text-xs leading-5">Shohrux</p>
          <div
            class="h-8 w-8 bg-green-100 rounded flex items-end justify-center"
          >
            <svg
              width="24"
              height="24"
